...
public class Quiz02RestController {
	...
	public List<Map<String, Object>> quiz02_1() {
		// @ResponseBody = return String => HttpMessageConverter String => 글자가 response에
		// 담긴다.
		// @ResponseBody = return 객체 => HttpMessageConverter 객체 jackson 라이브러리 => JSON 응답
		// - API
	...
	public ResponseEntity<Board> quiz02_3() {
		...
		return new ResponseEntity<>(board, HttpStatus.INTERNAL_SERVER_ERROR);		// 500
	}
}